        ...
        <div className="bg-white text-gray-900 p-8 rounded-xl border border-gray-200 dark:bg-gray-900 dark:text-gray-100 dark:border-gray-700">
          <div className="flex items-start justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1"># {quoteNumber}</p>
              <p className="text-sm text-gray-600 dark:text-gray-400">Date: {quoteDate}</p>
              {validUntil && <p className="text-sm text-gray-600 dark:text-gray-400">Valid Until: {validUntil}</p>}
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <input type="text" value={quoteNumber} onChange={(e) => setQuoteNumber(e.target.value)} className="input mt-1" />
              </div>
              <div>
                <label className="label">Date</label>
                <input type="date" value={quoteDate} onChange={(e) => setQuoteDate(e.target.value)} className="input mt-1" />
              </div>
              <div>
            ...
            <div>
              <label className="label">Notes / Terms &amp; Conditions</label>
              <textarea value={notes} onChange={(e) => setNotes(e.target.value)} placeholder="e.g. Payment terms, validity, delivery timeline..." className="input mt-1 min-h-[100px]" />
            </div>
