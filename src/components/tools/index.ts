...
const toolComponents: Record<string, () => Promise<{ default: ComponentType }>> = {
  ...
  "cgpa-to-percentage": lazyNamed(() => import("@/components/tools/calculators/cgpa-to-percentage"), "CgpaToPercentageTool"),
  "gpa-to-percentage": lazyNamed(() => import("@/components/tools/calculators/gpa-to-percentage"), "GpaToPercentageTool"),
  "attendance-calculator": lazyNamed(() => import("@/components/tools/calculators/attendance-calculator"), "AttendanceCalculatorTool"),
  ...
  "sarkari-resume-template": lazyNamed(() => import("@/components/tools/career/sarkari-resume-template"), "SarkariResumeTemplateTool"),
  ...
  "business-name-generator": lazyNamed(() => import("@/components/tools/business/business-name-generator"), "BusinessNameGeneratorTool"),
  ...
  "character-counter": lazyNamed(() => import("@/components/tools/developer/character-counter"), "CharacterCounterTool"),
  "qr-code-generator": lazyNamed(() => import("@/components/tools/developer/qr-code-generator"), "QrCodeGeneratorTool"),
  "password-generator": lazyNamed(() => import("@/components/tools/developer/password-generator"), "PasswordGeneratorTool"),
  "color-picker": lazyNamed(() => import("@/components/tools/developer/color-picker"), "ColorPickerTool"),
  "html-preview": lazyNamed(() => import("@/components/tools/developer/html-preview"), "HtmlPreviewTool"),
  "markdown-preview": lazyNamed(() => import("@/components/tools/developer/markdown-preview"), "MarkdownPreviewTool"),
  "base64-encoder-decoder": lazyNamed(() => import("@/components/tools/developer/base64-encoder-decoder"), "Base64EncoderDecoderTool"),
