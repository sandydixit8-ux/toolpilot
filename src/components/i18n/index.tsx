...
const translations = {
  en: {
    ...
    'hero.subtitle': '88+ free tools — PDF, images, calculators, career, business, developer & AI tools. No signup required.',
  ...
  hi: {
    ...
    'hero.subtitle': '88+ मुफ़्त टूल्स — PDF, इमेज, कैलकुलेटर, करियर, बिज़नेस, डेवलपर और AI टूल्स। साइनअप की ज़रूरत नहीं।',
